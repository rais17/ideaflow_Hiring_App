...
const ContactUs = () => {
  return (
    <section className="relative z-0 overflow-hidden bg-white md:px-28 px-8 py-20 lg:py-[120px]">
        ...
        <div className="flex flex-wrap -mx-4 lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p className="text-lg font-medium leading-relaxed text-gray-600 mb-9 font-Red-Hat-Display">
                ...
                need theres no better way to get a leg up.
              </p>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">(213) 458-5995</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
            ...
            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full p-3 text-white transition bg-blue-500 border rounded border-primary hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="text-body-color focus:border-blue-500 w-full resize-none rounded border border-[f0f0f0] px-[14px] py-3 text-base outline-none focus-visible:shadow-none"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="text-body-color focus:border-blue-500 w-full rounded border border-[f0f0f0] px-[14px] py-3 text-base outline-none focus-visible:shadow-none"
        />
      </div>
    </>
  );
